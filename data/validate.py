...
Uso:
    ...
    python data/validate.py data/scenarios/mini.json
...
escenario, no solo los que genera data/generate.py.
"""
...
def main(argv=None):
    ...
    if len(argv) != 1:
        print("Uso: python data/validate.py <ruta-al-escenario.json>", file=sys.stderr)
        return 2
