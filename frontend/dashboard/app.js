...
function renderConn(s) {
  ...
  if (s.conn === "offline") {
    ...
    $("banner-detail").textContent = s.connDetail || "si no arranca, revisa que backend/api/ esté en el puerto 8000";
  } else if (s.conn === "mock") {
    banner.classList.add("show", "warn");
...
/* ==================================================================
   ...
   ================================================================== */
// Pesos del contrato §4 (backend/api/priority.py). El breakdown ya viene ponderado: cada
