...
- **El reto (enunciado, rúbrica, obligatorios):** el steering de abajo. Enunciado íntegro en `docs/reto-happyrobot.md`.
...
- **Docs de producto:** `docs/escenario-incendio.md` (alcance, demo, backlog), `docs/contrato-de-datos.md` (vinculante para el código), `docs/brief-equipo-agente.md` (qué construye el equipo del agente), `docs/06-producto/01-vigia.md` (tesis Vigía y marco regulatorio).
- **Qué expone HappyRobot de verdad:** `docs/plataforma-happyrobot.md` (verificado, marcas [OK] / [?]) y el mirror de docs oficiales en `docs/_inbox/` (ver `docs/02-happyrobot/00-documentacion-oficial.md`).
