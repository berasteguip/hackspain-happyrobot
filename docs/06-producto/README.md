...
| [`12-tablas-basicas-twin.md`](12-tablas-basicas-twin.md) | El padrón en Twin (municipio → núcleo → domicilio → persona) contra el que el log de llamadas resuelve | Equipo del agente y quien toque Twin |
