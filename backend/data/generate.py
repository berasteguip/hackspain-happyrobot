...
Uso:
    python backend/data/generate.py --scenario sierra-culebra --seed 42 --houses 120 \
        --out backend/data/scenarios/sierra-culebra.json
...
def build_neighbor_graph(house_records, k_min=2, k_max=4, rng: random.Random = None):
    ...
    backend/data/tests/test_neighbor_coverage.py."""
    by_village = {}
