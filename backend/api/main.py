...
def sim_run(body: dict | None = None) -> JSONResponse:
    ...
    El simulador de variantes vive en `backend/sim/` (grafo de carreteras, capacidad de los corredores).
    ...
    return JSONResponse(
        ...
        content={
            "ok": False,
            "error": "/sim/run no se implementa en backend/api/: el simulador de variantes vive en backend/sim/.",
